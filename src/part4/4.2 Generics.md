...
methods like `array_windows::<N>()` on slices and array conversion functions
like `as_array::<N>()` rely on const generic parameters to provide compile-time
size guarantees. You will see both of these in the chapters ahead.
