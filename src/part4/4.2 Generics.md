...
Figure 4-1. Choosing between generics, impl Trait, and dyn Trait
...
Example 4-1. Comparing values with a trait-bounded generic function
...
Example 4-2. Combining static dispatch, opaque returns, and trait objects
