...
silently discard data: `1000_u32 as u8` quietly produces `232`. When you
encounter narrowing conversions later in the book, you will see safer
alternatives that catch these errors at runtime instead of silently truncating.
