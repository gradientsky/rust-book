...
- Deliberately omitted: custom error types with From impl (Part 5), thiserror/anyhow (Part 5), try blocks (nightly-only), inspect/inspect_err (better for Part 5 error handling chapter)
