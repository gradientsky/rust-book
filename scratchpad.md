...
- All 11 compilable code examples verified zero-warning (Rust 1.93.1, edition 2024); 2 does_not_compile examples verified (E0373 borrow in thread, E0277 Rc not Send); 5 `rust,ignore` examples (spawn signature, async/tokio)
